 ...
 */
object WeightedPageRank extends Logging {
   ...
   */
  def run[VD: ClassTag](
      graph: Graph[VD, Double], numIter: Int, resetProb: Double = 0.15): Graph[Double, Double] =
  {
    ...
    var rankGraph: Graph[Double, Double] = graph
      ...
      .mapTriplets( e => e.attr / e.srcAttr, TripletFields.Src )
